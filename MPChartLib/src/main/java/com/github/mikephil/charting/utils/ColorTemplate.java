...
public class ColorTemplate {
    ...
    public static final int[] JUVO_COLORS = {
            Color.rgb(238, 62, 3), Color.rgb(255, 129, 0), Color.rgb(127, 198, 247),
            Color.rgb(0, 76, 166), Color.rgb(78, 230, 190), Color.rgb(0, 183, 136)
    };
