...
public class RecyclerViewSwipeDecorator {
    ...
    public void setSwipeLeftBackground(Drawable swipeLeftBackground) {
        this.swipeLeftBackground = swipeLeftBackground;
    }
    ...
    public void setSwipeRightBackground(Drawable swipeRightBackground) {
        this.swipeRightBackground = swipeRightBackground;
    }
        ...
        try {
            ...
            if ( dX > 0 ) {
                ...
                if ( swipeRightBackground != null ) {
                    final Drawable background = swipeRightBackground;
                    background.setBounds(viewHolder.itemView.getLeft(), viewHolder.itemView.getTop(), viewHolder.itemView.getLeft() + (int) dX, viewHolder.itemView.getBottom());
                    background.draw(canvas);
                }
                ...
                if ( swipeLeftBackground != null ) {
                    final Drawable background = swipeLeftBackground;
                    background.setBounds(viewHolder.itemView.getRight() + (int) dX, viewHolder.itemView.getTop(), viewHolder.itemView.getRight(), viewHolder.itemView.getBottom());
                    background.draw(canvas);
                }
    ...
    public static class Builder {
        ...
        public Builder addSwipeRightBackground(Drawable drawable) {
            mDecorator.setSwipeRightBackground(drawable);
            return this;
        }
        ...
        public Builder addSwipeLeftBackground(Drawable drawable) {
            mDecorator.setSwipeLeftBackground(drawable);
            return this;
        }
